...
<div id="bo_gall" style="width:<?php echo $width; ?>">
    ...
    <ul id="gall_ul" class="gall_row">
        <?php for ($i=0; $i<count($list); $i++) {
            ...
            // glitter 🔽만료일이 존재하고, 현재 날짜 기준 3일 이내인 경우 tr_delete_soon 클래스 추가
            if (isset($list[$i]['wr_7']) && $list[$i]['wr_7'] != '0000-00-00' && $list[$i]['wr_7'] != ''
                && strtotime($list[$i]['wr_7']) <= strtotime(date('Y-m-d', strtotime('+3 days')))) {
                $classes[] = 'tr_delete_soon';
            } // -- glitter 🔼 3일 이내인 경우 tr_delete_soon 클래스 추가
            ...
            <li class="<?php echo implode(' ', $classes); ?>">
                <div class="gall_box">
                    ...
                    <div class="gall_con">
                        ...
                        <div class="gall_option">  <!-- glitter 🔽 -->
                            <span class="post_dead_label">삭제:</span>
